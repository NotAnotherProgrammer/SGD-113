...
public class Variables : MonoBehaviour
{
    ...
    void Start()
    {
        //Question 1b -Askcely to display myScing the console niore in console with a Debug.Log command.
        Debug.Log(myScore);
        ...
        //Question 7 -Making a floar for two seperate numbers. Taking the two floats, adding them together while asking for the average. 
